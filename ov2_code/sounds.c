...
static noise_note_t cannon_notes[] =
  {
    {.amp_begin = MAX_AMPLITUDE_PER_CHANNEL, .amp_end = MAX_AMPLITUDE_PER_CHANNEL, .multiplier = 4, .duration = 4410},
    {.amp_begin = MAX_AMPLITUDE_PER_CHANNEL/1.4, .amp_end = MAX_AMPLITUDE_PER_CHANNEL/1.4, .multiplier = 4, .duration = 4410},
    {.amp_begin = MAX_AMPLITUDE_PER_CHANNEL/1.96, .amp_end = MAX_AMPLITUDE_PER_CHANNEL/1.96, .multiplier = 4, .duration = 4410},
    {.amp_begin = MAX_AMPLITUDE_PER_CHANNEL/2.74, .amp_end = MAX_AMPLITUDE_PER_CHANNEL/2.74, .multiplier = 4, .duration = 4410},
    {.amp_begin = MAX_AMPLITUDE_PER_CHANNEL/3.84, .amp_end = MAX_AMPLITUDE_PER_CHANNEL/3.84, .multiplier = 4, .duration = 4410},
    {.amp_begin = MAX_AMPLITUDE_PER_CHANNEL/5.38, .amp_end = MAX_AMPLITUDE_PER_CHANNEL/5.38, .multiplier = 4, .duration = 4410},
    {.amp_begin = MAX_AMPLITUDE_PER_CHANNEL/7.53, .amp_end = MAX_AMPLITUDE_PER_CHANNEL/7.53, .multiplier = 4, .duration = 4410},
    {.amp_begin = MAX_AMPLITUDE_PER_CHANNEL/10.54, .amp_end = MAX_AMPLITUDE_PER_CHANNEL/10.54, .multiplier = 4, .duration = 4410},
    {.amp_begin = MAX_AMPLITUDE_PER_CHANNEL/14.76, .amp_end = MAX_AMPLITUDE_PER_CHANNEL/14.76, .multiplier = 4, .duration = 4410},
    {.amp_begin = MAX_AMPLITUDE_PER_CHANNEL/20.66, .amp_end = MAX_AMPLITUDE_PER_CHANNEL/20.66, .multiplier = 4, .duration = 4410},
